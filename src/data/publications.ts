...
export const PUBLICATIONS: PublicationItem[] = [
  ...
  },
  {
    ...
    publishedTime: {
      at: '2026-09-23T16:44:12Z',
      evidence: 'https://vercel.com/licklidermvp/website/BPM9tT6bvDZ9isHNihgJGBnWG2xD',
    },
  ...
  },
  {
    ...
    summary: 'A reported p-value collapse for a representable chi-square tail led to a merged statsmodels repair with regression coverage for related contingency-table paths.',
    href: '/engineering/statsmodels-contingency-table-tail-loss/',
    status: 'Fix merged into statsmodels main in PR #10276 — not yet released',
  },
  {
    category: 'Engineering',
  ...
  },
  {
    ...
    sortKey: '2026-09-15',
    publishedTime: { at: '2026-09-15T09:01:29Z', evidence: 'https://vercel.com/licklidermvp/website/51K9pQEBwPcEM9kNLkMm7YfUaokH' },
  ...
  },
  {
    ...
    status: 'Historical execution candidate preserved; candidate.5 successor has a merged development checkpoint; no additional supported capability',
  },
  {
    category: 'Engineering',
    type: 'Implementation note',
  ...
  },
  {
    ...
    status: 'Independently reviewed, unissued Release 4 candidate; D01/D07 amendment discussion open; no Protocol support',
  },
  {
    "category": "Blog",
  ...
  },
  {
    ...
    status: 'Public discussion open — reviewed unissued candidate; separate D01/D07 amendment window; no Protocol support',
  },
  {
    category: 'News',
    type: 'Product',
