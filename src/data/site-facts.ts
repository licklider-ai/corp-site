...
export const UPSTREAM_CONTRIBUTIONS = [
  ...
  },
  {
    ...
    observed: '0.0',
    reference: '≈ 7.076e-18',
    evidenceHref: 'https://github.com/statsmodels/statsmodels/commit/9f49dcd7281bd27747d0b6f988c07a13a4db747e',
    evidenceLabel: 'statsmodels merge commit 9f49dcd',
    credit: 'Reported by Tasuku Kobayashi · fix authored by Chetan Sahney · merged by Kevin Sheppard',
  },
  {
    project: 'statsmodels',
