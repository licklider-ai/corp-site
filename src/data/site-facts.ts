...
export const UPSTREAM_CONTRIBUTIONS = [
  ...
  },
  {
    ...
    outcome: 'report_open',
    panelStatus: 'Fix proposed · not yet accepted',
    ...
    credit: 'Repair proposed in PR #26135; no maintainer acceptance',
  },
  {
