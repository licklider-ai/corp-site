    ...
    sections: [
      {
        ...
        bullets: [
          `Display name: ${MCP_RELEASE.displayName}.`,
          `Client configuration name: ${MCP_RELEASE.configName}.`,
      ...
      },
      {
        ...
        paragraphs: [
          'Claude Code can register the server with the first command below. Other clients can use the same exact prerelease version in their MCP configuration so later npm tag changes cannot silently change the installed server.',
        ],
        code: `${NOMUE_MCP_CLAUDE_COMMAND}\n\n# Generic MCP client configuration\n${NOMUE_MCP_CLIENT_CONFIG}`,
        example: true,
        note:
